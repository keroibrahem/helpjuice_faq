...
Init_cruby(void)
{
  ...
  // Fix: cast the functions to (VALUE (*)(ANYARGS)) to match Ruby 3.2 signature
  rb_define_singleton_method(st_mSkiptrace, "current_bindings", (VALUE (*)(ANYARGS))st_current_bindings, 0);
  rb_define_method(rb_eException, "bindings", (VALUE (*)(ANYARGS))st_exc_bindings, 0);
